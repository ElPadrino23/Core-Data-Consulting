...
// RF-05: Actualizar estado de validacion de documento (con motivo y fecha)
module.exports.ActualizarEstadoDocumento = async (idDocumento, estadoValidacion, motivoRechazo) => {
    try {
        ...
        // Solo guardar motivo si es rechazo y viene con contenido
        if (estadoValidacion === 'Rechazado' && motivoRechazo && motivoRechazo.trim() !== '') {
            camposActualizar.motivorechazo = motivoRechazo.trim();
        } else {
            camposActualizar.motivorechazo = null;
        }
